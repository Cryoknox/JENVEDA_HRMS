...
public class HomePage extends BaseClass{
	...
	@FindBy(xpath="//h4[text()='Employee Self Service']")
	public WebElement employeeSelfservice;
	
	@FindBy(xpath = "//a[text()='My Claims']")
	public WebElement myClaimsIcon;
	...
	public AssetPage AssetIcon() throws Throwable 
	{
     ...
     public ImportExcelPage clickOnImportExcel() throws Throwable  {
		...
		importExcel.click();
		Thread.sleep(3000);
		return new ImportExcelPage();
	
     }
     
     public MyClaimsPage MyClaimIcon() throws Throwable
 	{
 	   Actions act=new Actions(driver);
 	   act.moveToElement(employeeSelfServiceIcon).perform();
 	   Thread.sleep(3000);
 	   myClaimsIcon.click();
 	   Thread.sleep(3000);
 	   return new MyClaimsPage();
 	}
